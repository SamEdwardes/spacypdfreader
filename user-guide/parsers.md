...
You could also be more verbose and pass in additional parameters. For a list of available parameters please refer to the pdfminer documentation for the [`extract_text`](https://pdfminersix.readthedocs.io/en/latest/reference/highlevel.html#extract-text) function.
...
- <https://github.com/SamEdwardes/spacypdfreader/blob/main/src/spacypdfreader/parsers/pdfminer.py>, or
- <https://github.com/SamEdwardes/spacypdfreader/blob/main/src/spacypdfreader/parsers/pytesseract.py>.
